const Banner = () => {
    ...
    return (
        <section className="relative w-full min-h-0 flex items-center justify-center">
            ...
            <form action="" className="w-2/5 h-96 z-40 my-14 bg-white rounded-md flex flex-col items-center justify-evenly">
                <h1 className="text-2xl text-center">Buscá tu nuevo empleo</h1>
                <input className="block w-4/5 text-lg p-2 bg-gray-300 placeholder-slate-900" type="text" placeholder="Puesto..."/>
                <input className="block w-4/5 text-lg p-2 bg-gray-300 placeholder-slate-900" type="text" placeholder="Ciudad..."/>
